...
exports.useActor = exports.defaultGetSnapshot = exports.isActorWithState = void 0;
...
function useActor(actorRef, getSnapshot) {
    ...
    var actorRefRef = (0, vue_1.isRef)(actorRef) ? actorRef : (0, vue_1.shallowRef)(actorRef);
    var state = (0, vue_1.shallowRef)(getSnapshot(actorRefRef.value));
    var send = function (event) {
        actorRefRef.value.send(event);
    };
    (0, vue_1.watch)(actorRefRef, function (newActor, _, onCleanup) {
