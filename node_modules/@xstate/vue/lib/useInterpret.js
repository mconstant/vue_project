...
function useInterpret(getMachine) {
    ...
    var service = (0, xstate_1.interpret)(machineWithConfig, interpreterOptions).start(rehydratedState ? xstate_1.State.create(rehydratedState) : undefined);
    var sub;
    (0, vue_1.onMounted)(function () {
        if (observerOrListener) {
            sub = service.subscribe((0, xstate_1.toObserver)(observerOrListener));
        }
    });
